...
const MobileProducts = () => {
  ...
  const FAKE_HEADER_HEIGHT = 80;

  return (
    <div id="products" className="bg-black min-h-screen text-white font-sans overflow-hidden pt-16">
            ...
            {selectedCategory ? (
              ...
              <div className="px-4">
                <header className="flex items-center justify-between py-3">
                  <button onClick={handleBack} className="flex items-center gap-1 p-2 -ml-2">
                    <ChevronLeft size={24} />
                    Back
                  </button>
                </header>
                <h1 className="text-center text-3xl font-bold tracking-[0.2em] uppercase my-2">
              ...
              // Category list view
              <div className="px-4">
                <h1 className="text-center text-3xl font-bold tracking-[0.2em] uppercase py-6">
                  Our Products
                </h1>
              </div>
            )}
