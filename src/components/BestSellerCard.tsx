    ...
    <div className="relative w-full max-w-lg mx-auto font-sans">
      ...
      >
        ...
        <div className="relative w-full sm:w-2/5 flex items-center justify-center p-4 sm:p-0 sm:py-8">
           <div className="relative w-52 h-64 sm:w-60 sm:h-80 -translate-y-4 sm:translate-y-0 sm:-translate-x-4">
            <Image
        ...
        <div className="w-full sm:w-3/5 flex flex-col p-6 text-white justify-center -mt-12 sm:mt-0">
          ...
          <div className='flex-grow'>
            ...
            <div className="flex items-center gap-8 mt-6">
                <div className="text-right flex flex-col items-center space-y-1">
                    <CircularProgress value={progressValue} size={40} strokeWidth={2} color={accentColor} />
          ...
          <div className="flex items-center gap-4 mt-8 pt-4 border-t border-white/10">
            ...
            <Button variant="ghost" size="sm" className="text-white/50 hover:text-white flex items-center gap-2 p-1">
                <Heart size={16}/>
